...
interface DAMAccordionProps {
  data: FeatureItem[]
}

export default function DAMAccordion({ data }: DAMAccordionProps) {
        ...
        <div className="bg-white rounded-lg shadow-md overflow-hidden">
          ...
          <div className="p-6">
            ...
            <button
              ...
              onClick={() => openModal(data[activeIndex].imageUrl, data[activeIndex].title)}
              aria-label={`View larger image of ${data[activeIndex].title}`}
            >
              <Image
